...
/** 
 * DAO for table "DB__DEVICE_HIS_DATA".
*/
public class DB_DeviceHisDataDao extends AbstractDao<DB_DeviceHisData, Long> {

    public static final String TABLENAME = "DB__DEVICE_HIS_DATA";

    /**
     * Properties of entity DB_DeviceHisData.<br/>
    ...
    */
    ...
    public DB_DeviceHisDataDao(DaoConfig config) {
        super(config);
    }
    
    public DB_DeviceHisDataDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"DB__DEVICE_HIS_DATA\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"DB__DEVICE_HIS_DATA\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, DB_DeviceHisData entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, DB_DeviceHisData entity) {
        stmt.clearBindings();
    ...
    @Override
    public DB_DeviceHisData readEntity(Cursor cursor, int offset) {
        DB_DeviceHisData entity = new DB_DeviceHisData( //
    ...
    @Override
    public void readEntity(Cursor cursor, DB_DeviceHisData entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(DB_DeviceHisData entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(DB_DeviceHisData entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
