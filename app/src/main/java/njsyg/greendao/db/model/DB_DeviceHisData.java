...
// KEEP INCLUDES END
/**
 * Entity mapped to table "DB__DEVICE_HIS_DATA".
 */
@Entity
public class DB_DeviceHisData {
    ...
    @Generated
    public DB_DeviceHisData() {
    }

    public DB_DeviceHisData(Long id) {
        this.id = id;
    }

    @Generated
    public DB_DeviceHisData(Long id, String device_sn, Integer device_state, Float device_U, Float device_I, Float device_P, Float device_electricity, java.util.Date updatetime, String remark) {
        this.id = id;
